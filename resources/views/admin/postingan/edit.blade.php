              ...
              <div class="col-md-6">
                <div class="form-group">
                    ...
                    <select name="status" class="form-control">
                      ...
                      <option value="2" {{ ($data->status == 2) ? 'selected' : '' }}>Tampil</option>
                      <option value="1" {{ ($data->status == 1) ? 'selected' : '' }}>Tidak Tampil</option>
                    </select>
                </div>
              </div>
              <div class="col-md-6">
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                    ...
                    <textarea name="meta" class="form-control">{{ $data->meta }}</textarea>
                  </div>
              </div>
            </div>
            <div class="form-group">
                ...
                <textarea name="body" class="myckeditor form-control" id="myckeditor">{!! $data->body !!}</textarea>
  ...
  <script>
      $(document).ready(function(){
        ...
        $('#form').submit(function(e){
          ...
          $.ajax({
                type: 'POST',
                url: `{{ route('admin.post.edit.post') }}`,
                data: formData,
                cache:false,
                contentType: false,
                processData: false,
